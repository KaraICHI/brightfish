...
public class ChooseChecklistActivity extends AppCompatActivity {

    RelativeLayout currentSortMethod;
    boolean sortdesc;
    Toolbar toolbar;

    public static void startChooseChecklistActivity(Context context) {
        Intent intent = new Intent(context, ChooseChecklistActivity.class);
    ...
    private void openSkipMenu() {
        ...
        dialog.setContentView(R.layout.dialog_skip_checklist);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ChooseChecklistActivity.this, "取消", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ChooseChecklistActivity.this, "确定", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        dialog.show();
    ...
    private void openSortMenu() {
        ...
        sortDialog.setContentView(R.layout.dialog_sort_checklist);
